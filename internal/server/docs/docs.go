        ...
        "/projects": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Maximum number of projects to return (default: 20, 0 for all)",
                        "name": "limit",
                        "in": "query"
                    },
                    {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/server.ActiveSessionsResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized - invalid or missing token",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/server.SessionMetadataResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/server.TeamsResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized - invalid or missing token",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/server.TeamMessagesResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized - invalid or missing token",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/server.TeamTasksResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized - invalid or missing token",
    ...
    "definitions": {
        ...
        "server.TeamMessagesResponse": {
            ...
            "properties": {
                "messages": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/thinkt.TeamMessage"
                    }
                }
            }
        },
        "server.TeamTasksResponse": {
            ...
            "properties": {
                "tasks": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/thinkt.TeamTask"
                    }
                }
            }
        },
        ...
        "server.ThemeColors": {
            ...
            "properties": {
                ...
                "assistant_block": {
                    "$ref": "#/definitions/server.ThemeStyle"
                },
                "assistant_label": {
                    "$ref": "#/definitions/server.ThemeStyle"
                },
        ...
        "server.ThemeInfo": {
            ...
            "properties": {
                ...
                "colors": {
                    "$ref": "#/definitions/server.ThemeColors"
                },
                "description": {
                    "type": "string"
                },
        ...
        "server.ThemesResponse": {
            ...
            "properties": {
                ...
                "themes": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/server.ThemeInfo"
                    }
                }
            }
        },
        ...
        "thinkt.Team": {
            ...
            "properties": {
                ...
                "members": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/thinkt.TeamMember"
                    }
                },
                "name": {
