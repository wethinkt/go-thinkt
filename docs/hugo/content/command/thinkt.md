...
Supports: Claude Code, Kimi Code, Gemini CLI, GitHub Copilot CLI, Codex CLI, Qwen Code
...
Examples:
  thinkt                          # Launch TUI
  thinkt sources list             # List available sources (claude, kimi, gemini, copilot, codex, qwen)
