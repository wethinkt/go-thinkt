...
🧠 thinkt — command cheat sheet
  ...
  │
  ├── config                Manage thinkt configuration
  ...
  │
  ├── export        Export a session as Markdown, HTML, or JSON
  │   └── template  Export user prompts using a Go template
  │
  ...
  │       ├── generate  Generate a new authentication token
  │       └── show      Print the running server's authentication token
  │
  ...
  │
  ├── share        Share sessions on share.wethinkt.com
  │   ├── delete   Delete a shared session
  │   ├── explore  Browse public sessions
  │   ├── list     List your shared sessions
  │   ├── login    Log in to share.wethinkt.com
  │   ├── logout   Log out of share.wethinkt.com
  │   ├── open     Open a session in the web browser
  │   ├── profile  Show your profile and stats
  │   ├── push     Upload a session to share.wethinkt.com
  │   ├── status   Show login and account status
  │   └── web      Open the share website in the web browser
  │
